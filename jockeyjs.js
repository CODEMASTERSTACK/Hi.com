...
let ridersStore = [
	{name: 'Krish', color: 'brown', number: 1},
	{name: 'Naitik', color: 'red', number: 2},
	{name: 'Chetna', color: 'lime', number: 3},
	{name: 'Vaibhav', color: 'purple', number: 4},
	{name: 'Vansh', color: 'orange', number: 5},
	{name: 'Gurbaaj', color: 'yellow', number: 6},
	{name: 'Rohit', color: 'gray', number: 7},
	{name: 'Siddhant', color: 'beige', number: 0},
	{name: 'Armaan', color: 'goldenrod', number: 8},
	{name: 'Vansh2', color: 'lightblue', number: 9},
	{name: 'Appu khote', color: 'lightgreen', number: 10},
	{name: 'Babu Rao', color: 'steelblue', number: 11},
